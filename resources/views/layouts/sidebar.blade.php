   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <div class="flex items-center ps-2.5 mb-5">
         <a href="{{ route('dashboard') }}" class="flex items-center">
            ...
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white ms-3">{{ config('app.name', 'Laravel') }}</span>
         </a>
      </div>
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-config" class="{{ request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? '' : 'hidden' }} py-2 space-y-2">
               <li>
               ...
               <li>
                  <a href="{{ route('roles.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('roles.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                     <span class="flex-1 ms-1 whitespace-nowrap">Roles</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('permissions.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('permissions.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                     <span class="flex-1 ms-1 whitespace-nowrap">Permissions</span>
                  </a>
               </li>
            </ul>
         </li>
         ...
         <li>
            <a href="{{ route('profile.edit') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('profile.edit') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
